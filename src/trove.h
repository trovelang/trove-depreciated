...
inline s32 compile(std::string& current_path, std::string& source_name);
inline s32 output_tokens(std::string& current_path, std::string& source_name);
inline s32 output_ast(std::string& current_path, std::string& source_name);
inline void help();
